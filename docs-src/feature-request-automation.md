...
./scripts/create-feature-issues.sh --dry-run --category deck-management
...
./scripts/create-feature-issues.sh --category deck-management

# Create only high-priority issues in a category
./scripts/create-feature-issues.sh --category deck-management --priority high
```
...
| `--category CATEGORY` | Filter by feature category | `--category deck-management` |
