...
This document defines the standard operating procedures for AI contributors to the `scrymat` project. Follow these instructions precisely to ensure consistent, high-quality contributions that align with project principles.
